...
var MapPoint = function MapPoint(pos, r, g, b, alpha, name) {
   ...
   this.setColor();
    ...
    // substract to do mapping (0,0) at top left.
    if(this.column == (62) && this.row == (200-21)) {
        this.name = 'sensor1';
    }
    else if(this.column == (66) && this.row == (200-35)) {
        this.name = 'sensor2';

    }
    else if(this.column == (76) && this.row == (200-41)) {
        this.name = 'sensor3';

    }
    else if(this.column == (88) && this.row == (200-45)) {
        this.name = 'sensor4';

    }
    else if(this.column == (103) && this.row == (200-43)) {
        this.name = 'sensor5';

    }
    else if(this.column == (102) && this.row == (200-22)) {
        this.name = 'sensor6';

    }
    else if(this.column == (89) && this.row == (200-3)) {
        this.name = 'sensor7';

    }
    else if(this.column == (74) && this.row == (200-7)) {
        this.name = 'sensor8';

    }
    else if(this.column == (119) && this.row == (200-42)) {
        this.name = 'sensor9';

    }
    // companies
    else if(this.column == (89) && this.row == (200-27)) {
        this.name = 'Roadrunner';

    }
    else if(this.column == (90) && this.row == (200-21)) {
        this.name = 'Kasios';

    }
    else if(this.column == (109) && this.row == (200-26)) {
        this.name = 'Radiance';

    }
    else if(this.column == (120) && this.row == (200-22)) {
        this.name = 'Indigo';

    }


    if (!!this.name && (this.name.startsWith('sensor') || this.isCompanyLocation())) {
        this.color = '#444444';
    }

    let rgba = hexToRgb(this.color);
    this.r = rgba[0];
    this.g = rgba[1];
    this.b = rgba[2];
...
MapPoint.prototype.isChemicalSensor = function isChemicalSensor() {
    return !!this.name && this.name.startsWith('sensor');
};

MapPoint.prototype.hasSensorLocated = function hasSensorLocated() {
    return this.isCamping() || this.isEntrance() || this.isRangerStop() || this.isGate() || this.isGeneralGate() || this.isRangerBase() || this.isChemicalSensor() || this.isCompanyLocation();
};
...
MapPoint.prototype.isCompanyLocation = function isCompanyLocation() {

    return this.name == 'Roadrunner' ||  this.name == 'Kasios' ||  this.name == 'Radiance' ||  this.name == 'Indigo';
};
...
MapPoint.prototype.setName = function setName(entranceIdx, gateIdx, generalGateIdx, rangeStopIdx, campingIdx) {
    ...
    if (!this.name) {
        ...
        console.warn('name has been assigned manually');
    }
};
...
ParkMap.CELL_WIDTH = 4;
ParkMap.CELL_HEIGHT = 4;
    ...
    if (showLabel) {
        ...
        this.svg.selectAll('.grid-label').data(mySensorPlaces).enter()
            ...
            .attr('x', function (cell) {
                ...
                if (cell.isChemicalSensor()) {
                    xOffset = 5;
                }

                return ParkMap.CELL_WIDTH + ParkMap.CELL_WIDTH * cell.getColumn() - xOffset;
